...
-- 10.2 스토어드함수
-- 10.2.1 스토어드함수의 개요
-- log_bin_trust_function_creators : OFF가 되어 있다면 ON으로 수정
...
-- step4 - insert
-- SIGNAL SQLSTATE '45000' : 오류를 강제 발생 명령
...
-- </실습 7> --CREATE FUNCTION userFunc(value1 INT, value2 INT) RETURNS INT BEGIN     RETURN value1 + value2; END
